...
import com.example.springbbootfirst.jwt.JwtAuthenticationFilter;
        ...
        return http
                .cors(cors -> cors  // ✅ Enable CORS
                        .configurationSource(request -> {
                            ...
                            corsConfig.setAllowedOrigins(List.of("http://localhost:5173","https://employee-management-system-wheat-pi.vercel.app/")); // Frontend origin
